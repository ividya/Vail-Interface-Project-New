...
- (void)viewDidLoad
{
    ...
    if([[InterfaceVariableManager sharedManager] feedbackMode] == SCREEN_FEEDBACK){
        ...
        //voiceTimer = [NSTimer scheduledTimerWithTimeInterval:1.0 target:self selector:@selector(receiveVoiceFeedback) userInfo:nil repeats:YES];
        
//        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveVoiceFeedback:) name:PATH_SELECTION_ADMIN object:nil];
    } 
}
